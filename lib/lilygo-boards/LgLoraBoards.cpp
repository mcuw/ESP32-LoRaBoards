...
static const char *TAG = "LgLoraBoards";
...
void printBoardStatus()
{
    ...
    if (disp) {
        ...
        disp->drawStr( 62, 38, "Radio:");    disp->drawStr( 120, 38, ( radioOnline ) ? "+" : "-");
...
bool beginRadioLib(bool restartOnFail) {
#if defined(USE_SX1262) || defined(USE_SX1276)
...
bool setupRadio(bool restartOnFail) {
#if defined(USE_SX1262) || defined(USE_SX1276)
